...
${OBJECTDIR}/_ext/4def93d5/Base.o: ../../Downloads/HW13/Base.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/Base.o ../../Downloads/HW13/Base.cpp

${OBJECTDIR}/_ext/4def93d5/PrivDerived.o: ../../Downloads/HW13/PrivDerived.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/PrivDerived.o ../../Downloads/HW13/PrivDerived.cpp

${OBJECTDIR}/_ext/4def93d5/ProtDerived.o: ../../Downloads/HW13/ProtDerived.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/ProtDerived.o ../../Downloads/HW13/ProtDerived.cpp

${OBJECTDIR}/_ext/4def93d5/PublicDerived.o: ../../Downloads/HW13/PublicDerived.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/PublicDerived.o ../../Downloads/HW13/PublicDerived.cpp

${OBJECTDIR}/_ext/4def93d5/dPriv.o: ../../Downloads/HW13/dPriv.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/dPriv.o ../../Downloads/HW13/dPriv.cpp

${OBJECTDIR}/_ext/4def93d5/dProt.o: ../../Downloads/HW13/dProt.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/dProt.o ../../Downloads/HW13/dProt.cpp

${OBJECTDIR}/_ext/4def93d5/dPublic.o: ../../Downloads/HW13/dPublic.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/dPublic.o ../../Downloads/HW13/dPublic.cpp

${OBJECTDIR}/_ext/4def93d5/main.o: ../../Downloads/HW13/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4def93d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4def93d5/main.o ../../Downloads/HW13/main.cpp
