...
class Main {
   ...
   public static void main(String args[]) {
      ...
      System.out.println("c02.getY( ): " + c02.getY( ));  //C0 getY

      System.out.println("c12.getA( ): " + c01.getA( )); //C0 getA
      System.out.println("c12.getB( ): " + c01.getB( )); //C0 getB
      System.out.println("c12.getC( ): " + ((C1) c01).getC( )); //C1 getC
      System.out.println("c12.getX( ): " + c01.getX( )); //C0 getX
      System.out.println("c01.getY( ): " + c01.getY( )); //C0 getY
      System.out.println("c01.getZ( ): " + c01.getY( )); //C0 getY
   }
}
